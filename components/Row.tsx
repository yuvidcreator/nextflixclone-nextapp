...
const Row = ({title, movies}: Props) => {
    ...
    return (
        <div className="h-40 space-y-0.5 md:space-y-2 mr-4 lg:mr-16">
            <h2 className="w-56 cursor-pointer text-sm font-semibold text-gray-300 transition hover:text-white md:text-2xl">{title}</h2>
